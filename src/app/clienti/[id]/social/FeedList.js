...
const moods = [
    { name: 'Excited', value: 'excited', icon: Flame, iconColor: 'text-white', bgColor: 'bg-red-500' },
    { name: 'Loved', value: 'loved', icon: Heart, iconColor: 'text-white', bgColor: 'bg-pink-400' },
    { name: 'Happy', value: 'happy', icon: Smile, iconColor: 'text-white', bgColor: 'bg-green-400' },
    { name: 'Sad', value: 'sad', icon: Frown, iconColor: 'text-white', bgColor: 'bg-yellow-400' },
    { name: 'Thumbsy', value: 'thumbsy', icon: ThumbsUp, iconColor: 'text-white', bgColor: 'bg-blue-500' },
    { name: 'I feel nothing', value: null, icon: XCircle, iconColor: 'text-gray-400', bgColor: 'bg-transparent' },
]
                            ...
                            <>
                                <div className="relative flex h-6 w-6 flex-none items-center justify-center bg-white">
                                    {activityItem.type === 'paid' ? (
                                        <CheckCircle size={16} strokeWidth={1.5} className="h-6 w-6 text-indigo-600" aria-hidden="true" />
                                    ) : (
                    ...
                    <div className="absolute inset-x-0 bottom-0 flex justify-between py-2 pl-3 pr-2">
                        <div className="flex items-center space-x-5">
                            <div className="flex items-center">
                                ...
                                >
                                    <Paperclip size={16} strokeWidth={1.5} className="h-5 w-5" aria-hidden="true" />
                                            ...
                                            <div className="relative">
                                                <Listbox.Button className="relative -m-2.5 flex h-10 w-10 items-center justify-center rounded-full text-gray-400 hover:text-gray-500">
                                                    <span className="flex items-center justify-center">
                                                        {selected.value === null ? (
                                                            <span>
                                                                <Smile className="h-5 w-5 flex-shrink-0" aria-hidden="true" />
